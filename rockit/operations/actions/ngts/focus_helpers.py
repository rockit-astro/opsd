...
from rockit.focuser.ok3z import FocuserStatus, CommandStatus as FocCommandStatus
...
def focus_set(log_name, position, timeout=FOCUS_TIMEOUT):
    ...
    try:
        with daemons.ngts_m06_focuser.connect(timeout=timeout) as focusd:
            print(f'moving focus to {position:.3f}')
