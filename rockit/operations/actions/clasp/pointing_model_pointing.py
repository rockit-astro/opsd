    ...
    def run_thread(self):
        ...
        while not self.aborted and self.dome_is_open:
            ...
            if failed or timeout:
                if failed:
                    print(f'PointingModelPointing: WCS failed for attempt {self._measurement_attempt} / {MEASUREMENT_ATTEMPTS}' )
                else:
                    print(f'PointingModelPointing: WCS timed out for attempt {self._measurement_attempt} / {MEASUREMENT_ATTEMPTS}')
