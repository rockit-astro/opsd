...
BuildArch:      noarch
Requires:       python3-warwick-observatory-operations python3-astropy python3-rockit-lmount python3-scipy
Requires:       python3-rockit-focuser python3-warwick-observatory-qhy-camera python3-rockit-pipeline python3-rockit-roof
